...
class DealGameThirtySeven: UIViewController {
    ...
    @IBOutlet weak var levelEighteen: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        Constant.storyboardName = "DealGameThirtySeven"
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Queen Of Hearts." && highCardTwo.text == "Queen Of Diamonds." || highCardOne.text == "Queen Of Diamonds." && highCardTwo.text == "Queen Of Hearts."   {
    ...
    @IBAction func btnClick(_ sender: UIButton) {
        ...
        case 3:
            ...
            if ( highCardTwo.text == ""){
                cardThree.alpha = 0
                if highCardOne.text == ""{
                    highCardOne.text = "Queen Of Diamonds."
                    firstChoice.setImage(UIImage(named: "queenDiamonds.png"), for: .normal)
                }else{
                    highCardTwo.text = "Queen Of Diamonds."
                    secondChoice.setImage(UIImage(named: "queenDiamonds.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Queen Of Diamonds."
        ...
        case 4:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "tenHearts.png"), for: .normal)
                }else{
                    highCardTwo.text = "Ten Of Hearts."
                    secondChoice.setImage(UIImage(named: "tenHearts.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Ten Of Hearts."
