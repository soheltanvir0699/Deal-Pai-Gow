...
class DealGameThirtySix: UIViewController {
    ...
    @IBOutlet weak var levelFive: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        Constant.storyboardName = "DealGameThirtySix"
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Jack Of Clubs." && highCardTwo.text == "Nine Of Hearts." || highCardOne.text == "Nine Of Hearts." && highCardTwo.text == "Jack Of Clubs."   {
