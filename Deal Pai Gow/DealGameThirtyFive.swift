...
class DealGameThirtyFive: UIViewController {
    ...
    @IBOutlet weak var levelFour: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        print("Level 4")
        Constant.storyboardName = "DealGameThirtyFive"
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Nine Of Hearts." && highCardTwo.text == "Seven Of Spades." || highCardOne.text == "Seven Of Spades." && highCardTwo.text == "Nine Of Hearts."   {
        ...
        case 2:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "tenDiamonds.png"), for: .normal)
                }else{
                    highCardTwo.text = "Ten Of Diamonds."
                    secondChoice.setImage(UIImage(named: "tenDiamonds.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Ten Of Diamonds."
        ...
        case 5:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "fiveDiamonds.png"), for: .normal)
                }else{
                    highCardTwo.text = "Five Of Diamonds."
                    secondChoice.setImage(UIImage(named: "fiveDiamonds.png"), for: .normal)
                }
