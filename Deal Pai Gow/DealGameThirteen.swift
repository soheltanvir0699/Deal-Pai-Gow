...
class DealGameTwentyThirteen: UIViewController {
    
    var audioPlayer = AVAudioPlayer()
    @IBOutlet weak var ImageView: UIImageView!
    @IBOutlet weak var levelThirteen: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        Constant.storyboardName = "DealGameTwentyThirteen"
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "King Of Clubs." && highCardTwo.text == "Two Of Clubs." || highCardOne.text == "Two Of Clubs." && highCardTwo.text == "King Of Clubs."   {
    ...
    @IBAction func payTwoButtonTapped(_ sender: Any) {
        ...
        var dogWin: UIImage!
        if payFortuneBet.text == "20" {
        payTwo.alpha = 0
        payFortuneBet.alpha = 0
        takeTwo.alpha = 0
        fortuneBetLabel.alpha = 0
        payMainBet.alpha = 0
        fortuneLabel.text = "20"
        ...
        case 4:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "kingClubs.png"), for: .normal)
                }else{
                    highCardTwo.text = "King Of Clubs."
                    secondChoice.setImage(UIImage(named: "kingClubs.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "King Of Clubs."
        ...
        case 6:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "eightHearts.png"), for: .normal)
                }else{
                    highCardTwo.text = "Eight Of Hearts."
                    secondChoice.setImage(UIImage(named: "eightHearts.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Eight Of Hearts."
