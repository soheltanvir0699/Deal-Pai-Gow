...
class DealGameTwentyTwo: UIViewController {
    
    
    @IBOutlet weak var setHandFourthChoice: UIButton!
    @IBOutlet weak var levelEight: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        Constant.storyboardName = "DealGameTwentyTwo"
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Joker." && highCardTwo.text == "Queen Of Hearts." || highCardOne.text == "Queen Of Hearts." && highCardTwo.text == "Joker."   {
        ...
        } else if highCardOne.text == "Ace Of Spades." && highCardTwo.text == "Queen Of Hearts." || highCardOne.text == "Queen Of Hearts." && highCardTwo.text == "Ace Of Spades."   {
            ...
            firstChoice.alpha = 0
            secondChoice.alpha = 0
            setHandCardOne.setImage(UIImage(named: "joker.png"), for: .normal)
            setHandCardTwo.setImage(UIImage(named: "aceHearts.png"), for: .normal)
            setHandCardThree.setImage(UIImage(named: "nineSpades.png"), for: .normal)
            setHandCardFour.setImage(UIImage(named: "sevenClubs.png"), for: .normal)
            setHandCardFive.setImage(UIImage(named: "threeHearts.png"), for: .normal)
        } else if highCardOne.text == "Ace Of Hearts." && highCardTwo.text == "Queen Of Hearts." || highCardOne.text == "Queen Of Hearts." && highCardTwo.text == "Ace Of Hearts."   {
            ...
            secondChoice.alpha = 0
            setHandCardOne.setImage(UIImage(named: "joker.png"), for: .normal)
            setHandCardTwo.setImage(UIImage(named: "aceSpades.png"), for: .normal)
            setHandCardThree.setImage(UIImage(named: "nineSpades.png"), for: .normal)
            setHandCardFour.setImage(UIImage(named: "sevenClubs.png"), for: .normal)
            setHandCardFive.setImage(UIImage(named: "threeHearts.png"), for: .normal)
        } else {
        ...
        case 1:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "joker.png"), for: .normal)
                }else{
                    highCardTwo.text = "Joker."
                    secondChoice.setImage(UIImage(named: "joker.png"), for: .normal)
        ...
        case 5:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "threeHearts.png"), for: .normal)
                }else{
                    highCardTwo.text = "Three Of Hearts."
                    secondChoice.setImage(UIImage(named: "threeHearts.png"), for: .normal)
                }
        ...
        case 6:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "aceHearts.png"), for: .normal)
                }else{
                    highCardTwo.text = "Ace Of Hearts."
                    secondChoice.setImage(UIImage(named: "aceHearts.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Ace Of Hearts."
        ...
        case 7:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "sevenClubs.png"), for: .normal)
                }else{
                    highCardTwo.text = "Seven Of Clubs."
                    secondChoice.setImage(UIImage(named: "sevenClubs.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Seven Of Clubs."
