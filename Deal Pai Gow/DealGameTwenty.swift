...
class DealGameTwenty: UIViewController {
    ...
    @IBOutlet weak var levelTwenty: UILabel!
    @IBOutlet weak var envyBonus: UILabel!
    @IBOutlet weak var payThree: UIButton!
    @IBOutlet weak var payEnvy: UITextField!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        print("Level 20")
        Constant.storyboardName = "DealGameTwenty"
        highCardOne.text = ""
        highCardTwo.text = ""
        payThree.alpha = 0
        payEnvy.alpha = 0
    ...
    @IBAction func payTwoButtonTapped(_ sender: Any) {
        if
        payFortuneBet.text == "75" {
        payTwo.alpha = 0
        payFortuneBet.alpha = 0
        takeTwo.alpha = 0
        payThree.alpha = 1
        fortuneBetLabel.alpha = 0
        fortuneLabel.text = "75"
    ...
    @IBAction func payThreeTapped(_ sender: Any) {
        if payEnvy.text == "5" {
            newGame.alpha = 1
            payEnvy.alpha = 0
            envyBonus.alpha = 0
