...
class DealGameThirtyEight: UIViewController {
    ...
    @IBOutlet weak var levelSixteen: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        Constant.storyboardName = "DealGameThirtyEight"
        print("Level 16")
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Queen Of Clubs." && highCardTwo.text == "Four Of Diamonds." || highCardOne.text == "Four Of Diamonds." && highCardTwo.text == "Queen Of Clubs."   {
