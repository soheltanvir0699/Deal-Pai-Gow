...
class DealGameThirtyOne: UIViewController {
    ...
    @IBOutlet weak var levelSix: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let kb = UIToolbar()
        Constant.storyboardName = "DealGameThirtyOne"
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Eight Of Clubs." && highCardTwo.text == "Eight Of Hearts." || highCardOne.text == "Eight Of Hearts." && highCardTwo.text == "Eight Of Clubs."   {
