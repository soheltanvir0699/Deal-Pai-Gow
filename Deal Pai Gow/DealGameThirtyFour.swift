...
class DealGameThirtyFour: UIViewController {
    ...
    @IBOutlet weak var levelTwelve: UILabel!
    @IBOutlet weak var setHandThirdChoice: UIButton!
    @IBOutlet weak var setHandFourthChoice: UIButton!
    @IBOutlet weak var setHandFifthChoice: UIButton!
    @IBOutlet weak var setHandCardTwoFive: UIButton!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        print("Level 12")
        Constant.storyboardName = "DealGameThirtyFour"
        let kb = UIToolbar()
        kb.sizeToFit()
        ...
        highCardOne.text = ""
        highCardTwo.text = ""
        setHandThirdChoice.alpha = 0
        setHandFourthChoice.alpha = 0
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Five Of Hearts." && highCardTwo.text == "Six Of Hearts." || highCardOne.text == "Six Of Hearts." && highCardTwo.text == "Five Of Hearts." {
        ...
        } else if highCardOne.text == "Five Of Hearts." && highCardTwo.text == "Six Of Diamonds." || highCardOne.text == "Six Of Diamonds." && highCardTwo.text == "Five Of Hearts." {
            playerLowHand.alpha = 1
            setHand.alpha = 0
            openPlayersCards.alpha = 1
            setHandCardOne.alpha = 1
            ...
            setHandCardFour.alpha = 1
            setHandCardFive.alpha = 1
            setHandThirdChoice.alpha = 1
            setHandFourthChoice.alpha = 1
            cardOne.alpha = 0
            cardTwo.alpha = 0
            cardThree.alpha = 0
            cardFour.alpha = 0
            ...
            firstChoice.alpha = 0
            secondChoice.alpha = 0
            setHandCardFour.setImage(UIImage(named: "sixHearts.png"), for: .normal)
        
        } else if highCardOne.text == "Five Of Clubs." && highCardTwo.text == "Six Of Diamonds." || highCardOne.text == "Six Of Diamonds." && highCardTwo.text == "Five Of Clubs." {
            playerLowHand.alpha = 1
            setHand.alpha = 0
            openPlayersCards.alpha = 1
            setHandCardOne.alpha = 1
            setHandCardTwo.alpha = 1
            setHandCardThree.alpha = 1
            setHandCardTwoFive.alpha = 1
            setHandCardFive.alpha = 1
            setHandThirdChoice.alpha = 1
            setHandFifthChoice.alpha = 1
            cardOne.alpha = 0
            cardTwo.alpha = 0
            cardThree.alpha = 0
            cardFour.alpha = 0
        ...
        } else if highCardOne.text == "Five Of Clubs." && highCardTwo.text == "Six Of Hearts." || highCardOne.text == "Six Of Hearts." && highCardTwo.text == "Five Of Clubs." {
            playerLowHand.alpha = 1
            setHand.alpha = 0
            openPlayersCards.alpha = 1
            setHandCardOne.alpha = 1
            ...
            firstChoice.alpha = 0
            secondChoice.alpha = 0
            cardFive.setImage(UIImage(named: "sixDiamonds.png"), for: .normal)
        } else {
            highCardOne.text = ""
            highCardTwo.text = ""
            cardOne.alpha = 1
        ...
        case 1:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "fiveClubs.png"), for: .normal)
                }else{
                    highCardTwo.text = "Five Of Clubs."
                    secondChoice.setImage(UIImage(named: "fiveClubs.png"), for: .normal)
        ...
        case 2:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "sevenHearts.png"), for: .normal)
                }else{
                    highCardTwo.text = "Seven Of Hearts."
                    secondChoice.setImage(UIImage(named: "sevenHearts.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Seven Of Hearts."
        ...
        case 3:
            ...
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "sixDiamonds.png"), for: .normal)
                }else{
                    highCardTwo.text = "Six Of Diamonds."
                    secondChoice.setImage(UIImage(named: "sixDiamonds.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Six Of Diamonds."
        ...
        case 4:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "nineSpades.png"), for: .normal)
                }else{
                    highCardTwo.text = "Nine Of Spades."
                    secondChoice.setImage(UIImage(named: "nineSpades.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Nine Of Spades."
        ...
        case 5:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "sixHearts.png"), for: .normal)
                }else{
                    highCardTwo.text = "Six Of Hearts."
                    secondChoice.setImage(UIImage(named: "sixHearts.png"), for: .normal)
                }
        ...
        case 6:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "eightClubs.png"), for: .normal)
                }else{
                    highCardTwo.text = "Eight Of Clubs."
                    secondChoice.setImage(UIImage(named: "eightClubs.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Eight Of Clubs."
        ...
        case 7:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "fiveHearts.png"), for: .normal)
                }else{
                    highCardTwo.text = "Five Of Hearts."
                    secondChoice.setImage(UIImage(named: "fiveHearts.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Five Of Hearts."
