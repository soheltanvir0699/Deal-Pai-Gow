...
class DealGameTwentyNine: UIViewController {
    ...
    @IBOutlet weak var levelFifthteen: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        Constant.storyboardName = "DealGameTwentyNine"
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Ten Of Spades." && highCardTwo.text == "Eight Of Diamonds." || highCardOne.text == "Eight Of Diamonds." && highCardTwo.text == "Ten Of Spades."   {
        ...
        case 1:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "twoHearts.png"), for: .normal)
                }else{
                    highCardTwo.text = "Two Of Hearts."
                    secondChoice.setImage(UIImage(named: "twoHearts.png"), for: .normal)
        ...
        case 3:
            ...
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "eightDiamonds.png"), for: .normal)
                }else{
                    highCardTwo.text = "Eight Of Diamonds."
                    secondChoice.setImage(UIImage(named: "eightDiamonds.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Eight Of Diamonds."
        ...
        case 4:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "twoSpades.png"), for: .normal)
                }else{
                    highCardTwo.text = "Ten Of Spades."
                    secondChoice.setImage(UIImage(named: "tenSpades.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Ten Of Spades."
                    firstChoice.setImage(UIImage(named: "tenSpades.png"), for: .normal)
                    cardFour.alpha = 0
                }
            }
        ...
        case 5:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "fourDiamonds.png"), for: .normal)
                }else{
                    highCardTwo.text = "Four Of Diamonds."
                    secondChoice.setImage(UIImage(named: "fourDiamonds.png"), for: .normal)
                }
