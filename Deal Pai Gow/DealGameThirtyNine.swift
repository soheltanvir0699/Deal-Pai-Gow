...
class DealGameThirtyNine: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        Constant.storyboardName = "DealGameThirtyNine"
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Ace Of Hearts." && highCardTwo.text == "Ace Of Diamonds." || highCardOne.text == "Ace Of Diamonds." && highCardTwo.text == "Ace Of Hearts."   {
        ...
        } else if highCardOne.text == "Ace Of Hearts." && highCardTwo.text == "Ace Of Clubs." || highCardOne.text == "Ace Of Clubs." && highCardTwo.text == "Ace Of Hearts."   {
            ...
            firstChoice.alpha = 0
            secondChoice.alpha = 0
            setHandCardFive.setImage(UIImage(named: "aceDiamonds.png"), for: .normal)
            setHandSecondChoice.setImage(UIImage(named: "aceClubs.png"), for: .normal)
        } else if highCardOne.text == "Ace Of Diamonds." && highCardTwo.text == "Ace Of Clubs." || highCardOne.text == "Ace Of Clubs." && highCardTwo.text == "Ace Of Diamonds."   {
            ...
            firstChoice.alpha = 0
            secondChoice.alpha = 0
            setHandCardFive.setImage(UIImage(named: "aceHearts.png"), for: .normal)
            setHandFirstChoice.setImage(UIImage(named: "aceDiamonds.png"), for: .normal)
            setHandSecondChoice.setImage(UIImage(named: "aceClubs.png"), for: .normal)
        ...
        case 1:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "threeDiamonds.png"), for: .normal)
                }else{
                    highCardTwo.text = "Three Of Diamonds."
                    secondChoice.setImage(UIImage(named: "threeDiamonds.png"), for: .normal)
        ...
        case 4:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "aceClubs.png"), for: .normal)
                }else{
                    highCardTwo.text = "Ace Of Clubs."
                    secondChoice.setImage(UIImage(named: "aceClubs.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Ace Of Clubs."
        ...
        case 5:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "sixClubs.png"), for: .normal)
                }else{
                    highCardTwo.text = "Six Of Clubs."
                    secondChoice.setImage(UIImage(named: "sixClubs.png"), for: .normal)
                }
        ...
        case 6:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "threeClubs.png"), for: .normal)
                }else{
                    highCardTwo.text = "Three Of Clubs."
                    secondChoice.setImage(UIImage(named: "threeClubs.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Three Of Clubs."
