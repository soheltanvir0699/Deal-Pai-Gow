...
class DealGameTwentyEight: UIViewController {
    ...
    @IBOutlet weak var levelNine: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        print("Level 9")
        Constant.storyboardName = "DealGameTwentyEight"
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Jack Of Hearts." && highCardTwo.text == "Jack Of Spades." || highCardOne.text == "Jack Of Spades." && highCardTwo.text == "Jack Of Hearts."   {
    ...
    @IBAction func payTwoButtonTapped(_ sender: Any) {
        ...
        var dogWin: UIImage!
        if payFortuneBet.text == "25" {
            payTwo.alpha = 0
            takeTwo.alpha = 0
            payFortuneBet.alpha = 0
            fortuneBetLabel.alpha = 0
            fortuneLabel.text = "25"
        ...
        case 6:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "jackSpades.png"), for: .normal)
                }else{
                    highCardTwo.text = "Jack Of Spades."
                    secondChoice.setImage(UIImage(named: "jackSpades.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Jack Of Spades."
        ...
        case 7:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "sixSpades.png"), for: .normal)
                }else{
                    highCardTwo.text = "Six Of Spades."
                    secondChoice.setImage(UIImage(named: "sixSpades.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Six Of Spades."
