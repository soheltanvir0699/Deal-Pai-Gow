...
class DealGameTwentyThree: UIViewController {
    
    
    @IBOutlet weak var levelEleven: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        Constant.storyboardName = "DealGameTwentyThree"
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Joker." && highCardTwo.text == "Six Of Diamonds." || highCardOne.text == "Six Of Diamonds." && highCardTwo.text == "Joker."   {
    ...
    @IBAction func btnClick(_ sender: UIButton) {
        ...
        case 7:
            if ( highCardTwo.text == ""){
                cardSeven.alpha = 0
                if highCardOne.text == ""{
                    highCardOne.text = "Nine Of Diamonds."
                    firstChoice.setImage(UIImage(named: "nineDiamonds.png"), for: .normal)
                }else{
                    highCardTwo.text = "Nine Of Diamonds."
                    secondChoice.setImage(UIImage(named: "nineDiamonds.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Nine Of Diamonds."
