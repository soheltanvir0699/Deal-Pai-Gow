...
class DealGameTwentyFour: UIViewController {
    ...
    @IBOutlet weak var levelSeven: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        Constant.storyboardName = "DealGameTwentyFour"
        print("Level 7")
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Ace Of Clubs." && highCardTwo.text == "Ace Of Diamonds." || highCardOne.text == "Ace Of Diamonds." && highCardTwo.text == "Ace Of Clubs."   {
    ...
    @IBAction func payTwoButtonTapped(_ sender: Any) {
        ...
        var dogWin: UIImage!
        if payFortuneBet.text == "15" {
            payTwo.alpha = 0
            takeTwo.alpha = 0
            payFortuneBet.alpha = 0
            fortuneBetLabel.alpha = 0
            fortuneLabel.text = "15"
        ...
        case 7:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    secondChoice.setImage(UIImage(named: "twoSpades.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Two Of Spades."
