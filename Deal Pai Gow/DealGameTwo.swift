...
class DealGameTwo: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        Constant.isFirstTimeOpen = true
        Constant.storyboardName = "DealGameTwo"
        print("Level 2")
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func payTwoButtonTapped(_ sender: Any) {
        ...
        if payFortuneBet.text == "10" {
            ...
            func animate_images()
            {
                let myimgArr = ["starOne.png","starTwo.png","starThree.png","starFour.png","starFive.png","starSix.png","starSeven.png"]
                var images = [UIImage]()
                ...
                starImageView.animationImages = images
                starImageView.animationDuration = 0.3
                starImageView.animationRepeatCount = 75
