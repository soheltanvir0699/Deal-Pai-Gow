...
class DealGameTwentyFive: UIViewController {
    
    
    @IBOutlet weak var levelFourteen: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        Constant.storyboardName = "DealGameTwentyFive"
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Queen Of Hearts." && highCardTwo.text == "Jack Of Clubs." || highCardOne.text == "Jack Of Clubs." && highCardTwo.text == "Queen Of Hearts."   {
    ...
    @IBAction func btnClick(_ sender: UIButton) {
        ...
        case 4:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "kingDiamonds.png"), for: .normal)
                }else{
                    highCardTwo.text = "King Of Diamonds."
                    secondChoice.setImage(UIImage(named: "kingDiamonds.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "King Of Diamonds."
        ...
        case 6:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "fourSpades.png"), for: .normal)
                }else{
                    highCardTwo.text = "Four Of Spades."
                    secondChoice.setImage(UIImage(named: "fourSpades.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Four Of Spades."
        ...
        case 7:
            if ( highCardTwo.text == ""){
                cardSeven.alpha = 0
                if highCardOne.text == ""{
                    highCardOne.text = "Three Of Spades."
                    firstChoice.setImage(UIImage(named: "threeSpades.png"), for: .normal)
                }else{
                    highCardTwo.text = "Three Of Spades."
                    secondChoice.setImage(UIImage(named: "threeSpades.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Three Of Spades."
