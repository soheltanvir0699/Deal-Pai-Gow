...
class DealGameThirty: UIViewController {
    ...
    @IBOutlet weak var copyHand: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        Constant.storyboardName = "DealGameThirty"
        print("Level 3")
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Ace Of Clubs." && highCardTwo.text == "Queen Of Hearts." || highCardOne.text == "Queen Of Hearts." && highCardTwo.text == "Ace Of Clubs."   {
        ...
        case 1:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "eightSpades.png"), for: .normal)
                }else{
                    highCardTwo.text = "Eight Of Spades."
                    secondChoice.setImage(UIImage(named: "eightSpades.png"), for: .normal)
