...
class DealGameThirtyTwo: UIViewController {
    
    
    @IBOutlet weak var levelTen: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        Constant.storyboardName = "DealGameThirtyTwo"
        let kb = UIToolbar()
        kb.sizeToFit()
    ...
    @IBAction func setHandTapped(_ sender: Any) {
        if highCardOne.text == "Jack Of Hearts." && highCardTwo.text == "Ten Of Clubs." || highCardOne.text == "Ten Of Clubs." && highCardTwo.text == "Jack Of Hearts."   {
        ...
        case 2:
            if ( highCardTwo.text == ""){
                ...
                if highCardOne.text == ""{
                    ...
                    firstChoice.setImage(UIImage(named: "queenClubs.png"), for: .normal)
                }else{
                    highCardTwo.text = "Queen Of Clubs."
                    secondChoice.setImage(UIImage(named: "queenClubs.png"), for: .normal)
                }
            }else{
                if checkResult(){
                    highCardOne.text = "Queen Of Clubs."
